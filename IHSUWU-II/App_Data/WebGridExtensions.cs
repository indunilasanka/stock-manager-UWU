...
public static class WebGridExtensions
{
        ...
        bool explicitlyCalled)
    {
        ...
        if (ModeEnabled(mode, WebGridPagerModes.FirstLast))
        {
            ...
            if (currentPage + numericLinksCount / 2 >= numericLinksCount && !(currentPage == lastPage && numericLinksCount > lastPage))
            {
                li.Add(part);
            }
        ...
        if (ModeEnabled(mode, WebGridPagerModes.FirstLast))
        {
            ...
            if (currentPage + numericLinksCount / 2 < lastPage && !(currentPage == 0 && numericLinksCount > lastPage))
            {
                li.Add(part);
            }
